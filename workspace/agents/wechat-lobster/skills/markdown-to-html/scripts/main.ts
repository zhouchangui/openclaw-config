...
import {
  ...
  inlineCss, normalizeInlineCss, modifyHtmlStructure, removeFirstHeadingIfMatchesTitle,
...
export async function convertMarkdown(
  ...
  if (!keepTitle) htmlContent = removeFirstHeadingIfMatchesTitle(htmlContent, title);
...
Options:
  ...
  --theme <name>      Theme name (default, simple). Default: default
...
Example:
  ...
  npx -y bun main.ts article.md --theme default

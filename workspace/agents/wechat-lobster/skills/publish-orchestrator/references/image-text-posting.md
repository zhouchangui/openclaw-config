...
npx -y bun ./scripts/wechat-browser.ts --title "Title" --content "Content" --image img1.png --image img2.png
...
3. **Compresses title** to 20 characters if too long:
   - Original: "How to Completely Transform Your Life in One Day"
   - Compressed: "Transform Your Life in a Day"
...
1. Parses markdown meta:
   - Title: "How to Completely Transform Your Life in One Day" → "Transform Your Life in a Day"
   - Author: from frontmatter or default
2. Extracts content from first paragraphs
3. Finds 7 images in xhs-images/
4. Opens Chrome, navigates to WeChat "Image-Text" editor
